      ...
      <article>
        ...
        <div className="about-phyff">
          <p> PHYFF is a student-run event dedicated to helping teenage creatives find their voice in a
            ...
            Philadelphia
            schools and ones across the world.
          </p>
          <p> This festival is a great opportunity to show off work and get critiques, as well as to network
            ...
            workshops on a
            variety of common and niche filmmaking focuses.
          </p>
          <p>The Festival is open to high school students in the greater Philadelphia area and beyond with
            free
            participation for all students, and it includes an awards ceremony for the winning films.
          </p>
        </div>
        <h1> LAST YEAR'S FEST </h1>
        <h3> Check out our
          <a href="https://www.youtube.com/watch?v=tNEeq406aO0&feature=youtu.be">
            highlight reel!
          </a>
        </h3>
        <div className="prev-winners">
          ...
          <div className="experimental">
            ...
            <p>2nd
              <span>
                <a href="https://vimeo.com/265272751">
          ...
          <div className="documentary">
            ...
            <p>2nd
              <span>
                <a href="https://www.youtube.com/watch?v=z-i9p6yv5o4">The Island of Music</a>
              </span>
              Lily Annenberg
            </p>
